// ======================================================================
// \title  due_devTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef DUE_DEV_DUE_DEVTOPOLOGY_HPP
#define DUE_DEV_DUE_DEVTOPOLOGY_HPP
// Included for access to due_dev::TopologyState and due_dev::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <due_dev/Top/due_devTopologyDefs.hpp>

// Remove unnecessary due_dev:: qualifications
 ...
 * due_dev::TopologyState see: due_devTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type due_dev::TopologyState see: due_devTopologyDefs.hpp.
 *
